...
<style>
  ...
  .tk-badge { flex-shrink: 0; display: inline-block; font-size: 10px; padding: 2px 8px; border-radius: 4px; font-weight: 600; min-width: 60px; text-align: center; }
  .b-invited { background: #E6F1FB; color: #0C447C; }
  .b-conf { background: #EEEDFE; color: #3C3489; }
  .b-workshop { background: #E1F5EE; color: #085041; }
  .b-school { background: #FAEEDA; color: #633806; }
  .b-online { background: #F1EFE8; color: #444441; }
  ...
  html[data-theme="dark"] .b-invited { background: #042C53; color: #B5D4F4; }
  ...
  html[data-theme="dark"] .b-online { background: #2C2C2A; color: #D3D1C7; }
...
<div class="tk-tl">
  ...
  <div class="tk-year">
    ...
    <div class="tk-list">
      <div class="tk-item">
        <span class="tk-badge b-invited">Invited</span>
      ...
      <div class="tk-item">
        <span class="tk-badge b-school">Summer school</span>
      ...
      <div class="tk-item">
        <span class="tk-badge b-school">Winter school</span>
